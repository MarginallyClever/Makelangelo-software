...
#define BOARD_AMS1  (1)
#define BOARD_AMS2  (2)
#define BOARD_RUMBA (3)

// Change this to your board type
#define THIS_BOARD  BOARD_RUMBA


#if !defined(THIS_BOARD)
#error You must define THIS_BOARD in configure.h
#endif

#if THIS_BOARD == BOARD_RUMBA
