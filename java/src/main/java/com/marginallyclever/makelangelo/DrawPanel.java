...
public class DrawPanel extends GLJPanel implements MouseListener, MouseInputListener, GLEventListener  {
    ...
    private ArrayList<DrawPanelNode> fast_nodes = new ArrayList<>();
    ...
    public void ZoomToFitPaper() {
        final MachineConfiguration machineConfiguration = MachineConfiguration.getSingleton();
        final int drawPanelWidth = this.getWidth();
        final int drawPanelHeight = this.getHeight();
        final double widthOfPaper = machineConfiguration.paper_right - machineConfiguration.paper_left;
        final double heightOfPaper = machineConfiguration.paper_top - machineConfiguration.paper_bottom;
