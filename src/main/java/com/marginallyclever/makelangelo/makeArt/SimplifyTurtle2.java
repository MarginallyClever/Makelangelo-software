 ...
 *
 */
public class SimplifyTurtle2 extends AbstractAction {
	private static final long serialVersionUID = 7013596037448318526L;
	private static final Logger logger = LoggerFactory.getLogger(SimplifyTurtle2.class);
	private Makelangelo myMakelangelo;

	private static double distanceTolerance = 1.6;
	
	public SimplifyTurtle2(Makelangelo m) {
		super(Translator.get("Simplify2"));
		myMakelangelo=m;
	}
	...
	public static void setDistanceTolerance(double distanceTolerance) {
		SimplifyTurtle2.distanceTolerance = distanceTolerance;
	}
}
