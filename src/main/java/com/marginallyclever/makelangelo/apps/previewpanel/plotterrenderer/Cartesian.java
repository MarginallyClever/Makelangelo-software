...
public class Cartesian implements PlotterRenderer {
	final public double CARTESIAN_MOTOR_MOUNT_SIZE =45; //cm
	final public double CARTESIAN_PLOTTER_SIZE=60; //cm
	final public double CARTESIAN_PLOTTER_OUTER_SIZE=70; //cm
	final public double CARTESIAN_PLOTTER_HOLE_SIZE=20; //cm
	final public double CARTESIAN_MOTOR_BODY_SIZE =42; //cm
