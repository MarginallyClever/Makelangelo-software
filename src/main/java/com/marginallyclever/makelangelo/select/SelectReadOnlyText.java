...
/**
 * Read only JEditorPane with an HyperLinckListener for text/html contening or not multiple html link.
 * With clickable link (Desktop.BROWSE) and ToolTips when hovered over .
 * 
 * @author Dan Royer (and modified by PPAC37)
 * @since 7.24.0
 */
public class SelectReadOnlyText extends Select {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8918068053490064344L;// TODO to regenerat ?
	...
	public static JEditorPane createJEditorPaneWithHyperlinkListenerAndToolTipsForDesktopBrowse(String sToSetAsTextToTheHtmlEditorPane) {
		...
		createdJEditorPane.addHyperlinkListener(new HyperlinkListener() {
			@Override
