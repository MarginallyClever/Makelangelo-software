...
//		}
	...
	/**
	 * Building the avrdude command and aguments. Refer to
	 ...
	 *
	 * @param avrdudeExecCmdFullPathForTheOs the avrdude commande in the system,
	 * "avrdude" or "avrdude.exe" or the full path ...
	 * @param fAvrdudeConfFile the path to the avrdude.conf file to use
	 * @param confPath TODO get ride of this arg ... doublon juste not to take
	 * care of posible exception getAbsolutPath
	 * @param portName
	 * @param hexPath the path of the file .hex to read from the flash to be
	 * upload to the microcontroleur.
