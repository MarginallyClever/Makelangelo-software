...
public class ProcessExecCmd {
     ...
     * <p>
     * Warning: As this is a command to be
     ...
     * <li>a ProcessExecStreamGobbler interface to ease the
 implementation.</li>
     ...
     * ?
     *
     * @param cmdArray (command and arguments) used to create
