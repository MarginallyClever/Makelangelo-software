...
import com.marginallyclever.makelangelo.paper.PanelAdjustPaper;
 ...
 * @since 7.1.4
 */
public class DialogMachineSettings extends JDialog {
	/**
	 * 
	 */
	private static final long serialVersionUID = 160311400233657182L;
	...
	public DialogMachineSettings(Frame owner,String title) {
		super(owner,title);
	}

	// display settings menu
	public void run(RobotController myRobotController) {
		JPanel panel = new JPanel();
		originalHardwareVersion = myRobotController.getSettings().getVersion();
	...
	private void buildModelPanel() {
		...
		// set the default
		String hv = myRobotController.getSettings().getVersion();
