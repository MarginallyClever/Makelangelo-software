...
public class Generator_Polyeder extends ImageGenerator {
	...
	public ImageGeneratorPanel getPanel() {
		if(models == null)
		{
			...
			addModel("Football",new int[] {5,4,3,0,4,0,3,0,1,1,5,0,4,0,5,0,4,0,1,3,0,1,4,0,1,1,1,1,4,3,0,4,0,3,0,1,1,5,0,4,0,5,0,1,1,1,1,4,3,0,1,1,1,0,3,1,0,4,1,1,0,3,1,0
