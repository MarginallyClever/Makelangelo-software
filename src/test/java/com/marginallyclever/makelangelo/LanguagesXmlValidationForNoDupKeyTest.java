...
//	//URL schemaFile = new File("src/test/resources/translator/language_no_dup_key.xsd").toURI().toURL();
   ...
   /**
    * Validate an xml file with an external xsd Schema.
    * src inspiration : https://stackoverflow.com/questions/15732/whats-the-best-way-to-validate-an-xml-file-against-an-xsd-file
    * 
    * @param xmlFileToValidate the xml file to validate.
    * @param schemaFile the xsd schema file to use to validate the xml file.
    * @return true if the validation is a succes ( no warm, error or fatal error ) false otherwise and if other exception ( cant found file xml, or xsd, or xsd not valid) occure.
    */
