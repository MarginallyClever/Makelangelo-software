...
*The hardware*
* An Arduino Duemilanova 328 or better ($30)
* one USB cable to connect the Arduino to your PC ($1)
* one Adafruit stepper motor shield ($20)
* two NEMA17 stepper motors ($30)
* one 12 volt, 2 amp power supply ($15)
* two sewing machine bobbins ($1)
...
# Center the plotter: gently turn the bobbins until the plotter is halfway between the steppers and halfway between the top and bottom of the area you will draw in.  I recommend you only do this with the power off.  Later versions will be self-centering.
# Measure the distance (cm) R-L.  This will be the X_SEPARATION value at the top of the arduino_code.ino file.
# Measure the distance (cm) P-O.  This will be the LIMYMAX value.
# Measure the distance (cm) LIMYMAX-H.  This will be the LIMYMIN value.
...
# Upload your changes to the Mega.  Open the Arduino Serial Interface.  You should see "== HELLO WORLD ==" followed by the minimum - maximum limits, the feed rate, and the acceleration, followed by instructions.
